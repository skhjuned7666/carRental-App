      ...
      <div className='container mx-auto'>
        ...
        <div className='grid grid-cols-1 md:grid-cols-3 gap-8'>
          {testimonials.map((testimonial) => (
            <div
              key={testimonial.id}
              className='glow-effect bg-gradient-to-br from-[#2E2E2E]/80 to-black backdrop-blur-lg rounded-2xl p-8 border border-[#2E2E2E] transition-all duration-300 hover:scale-105'>
